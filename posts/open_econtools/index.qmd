...
Over the past couple of years, I've been building up a loose 'regional economic data' toolkit while trying to answer questions posed in my Y-PERN work (mainly with [SYMCA](https://www.southyorkshire-ca.gov.uk/)). I am working on pulling this all together onto a [regionaleconomictools website](https://danolner.github.io/RegionalEconomicTools/), though there are bits elsewhere (the [live outputs page](https://danolner.github.io/posts/outputs_livelist/) on the techie blog has gathered most of it in one place).
