...
[^githublink]: [Github file history](https://github.com/DanOlner/coveredinbees/commits/master/posts/open_econtools/index.qmd) for previous drafts / cuttings.
...
A lot of that groundwork has been done already through regional network building. We have a decent chance of getting a handle on a good two-thirds to three-quarters of the pachyderm.
...
By building pipelines like this, we can speed up reports, maps, dashboards etc, and share them easily (that last link collects a bunch of these in one place). 