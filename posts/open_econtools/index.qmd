...
Over the past couple of years, I've been building up a loose 'regional economic data' toolkit while digging into UK sectors and growth (mainly with [SYMCA](https://www.southyorkshire-ca.gov.uk/) through my [Y-PERN](https://y-pern.org.uk/) work). 

Over the next six months or so, I want to try and make this a more focused project - working title 'open econ collab tools'. I'm pulling this all together onto a [regecontools website](https://danolner.github.io/RegionalEconomicTools/), though bits are spread all over (this [live outputs page](https://danolner.github.io/posts/outputs_livelist/) on the techie blog has gathered most of it in one place).
...
* Help build capacity through things like [this ONS Local session](https://vimeo.com/user99857619/review/1103090076/32e50123d2) I ran introducing R for regional economic analysis ([online slides here](https://danolner.github.io/RegionalEconomicTools/R_regecon_taster_2025_revealjs.html#/title-slide) go through everything, including using R in the browser).

The least tested part of this (at least for me) is the 'tools/ideas/questions' cycle. Y-PERN has been trying to push past [deficit model](https://en.wikipedia.org/wiki/Information_deficit_model) thinking, which imagines a “transfer of information from experts to non-experts”. This is still a pretty entrenched view: academics toil in the dark for years and emerge pale and blinking with new economic insights. Those perhaps eventually 'transfer' into the tools we use.

But that doesn't align with the reality of data-driven policymaking: *everyone involved* are experts in what they do. This is a deeply collaborative endeavour. We don’t all have the same knowledge, but we also won’t progress much without bringing everyone’s together.

So there's a symbiosis between the 'ideas' part and the 'open' part. Here's the philosophy I want to use:
...
I don’t have a dogmatic fealty to open source — I believe in a data/analysis mixed economy where private providers can do things other can’t. There are also essential datasets that of course can't be open. But *where we can*, working in the open just goes better with the grain of those three things: (1) collaborative learning/capacity building across silos; (2) developing our shared sense of ground truth; (3) avoiding wheel reinvention.
...
* At the top, we've got “What does the economy look like” questions. We want direct answers - how is the economy structured, what's growing, shrinking, why do we think this is happening, do we have any levers? We want to get eyes on as much of the elephant as we can.
* Those lead naturally to “What data/methods do we have to answer them?” Any one data source helps us grab a single section of pachiderm. We use multiple sources to get a grip on different bits, but the whole beast will likely still elude us. 
