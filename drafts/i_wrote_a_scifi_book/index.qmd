...
A few months later, at the end of 2022, openAI [released](https://www.searchenginejournal.com/history-of-chatgpt-timeline/488370/) chatGPT 3.5 for public use. Three years have passed since. That Oatmeal panel above (from [this piece](https://theoatmeal.com/comics/ai_art)) nicely captures where we are now - there's a decent chance you're done with hearing a another ****ing word about AI. By now, you may well be willing to pay cash if companies would please God stop shoving it into every single product.
...
I am **also** working on the impact of AI in the workplace as part of my day job. 
So say something about threading a line between what that's trying to do - i.e. steer our way through something intrinsically unpredictable
And what fiction should or can do. Le Guin. Then onward. 
