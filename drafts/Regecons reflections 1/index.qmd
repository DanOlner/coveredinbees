...
![Pasted image 20260204141532.png](https://exobrain.coveredinbees.org/pasted-image-20260204141532png/)
...
![Pasted image 20260204150037.png](https://exobrain.coveredinbees.org/pasted-image-20260204150037png/)
...
We'll come back to those exclusions in later posts. But here, it means we're using actual survey results, not relying on some of the more [heroic](https://exobrain.coveredinbees.org/heroic-assumptions/) estimation/modelling assumptions that go into other aspects of GVA.
...
We'll start with growth in the chained volume data, as it's actually slightly easier to play with (as we'll see below with LQs).
...
- [ ] The annual business survey (ABS, [point data](https://www.ons.gov.uk/businessindustryandtrade/business/businessservices/datasets/uknonfinancialbusinesseconomyannualbusinesssurveyregionalresultssectionsas) and [error data](https://www.ons.gov.uk/businessindustryandtrade/business/businessservices/datasets/uknonfinancialbusinesseconomyannualbusinesssurveyregionalresultsqualitymeasures) are in different places; I download and wrangle those together in the code [here](https://github.com/DanOlner/RegionalEconomicTools/blob/gh-pages/bits_of_code/ABS_error_rates.R)) 
- [ ] The Business Register and Employment Survey ([BRES](https://www.nomisweb.co.uk/sources/bres)). This doesn't come with uncertainty values for... hmm... 
- [ ] Or possibly the APS/LFS for productivity ([productivity QMI](https://www.ons.gov.uk/employmentandlabourmarket/peopleinwork/labourproductivity/methodologies/labourproductivityqmi)) "Labour inputs come from the Labour Force Survey (LFS). The LFS provides average actual hours worked by workers used in the calculation of output per hour, total UK workers needed for Output per worker and the self-employed component of jobs."
